...
This project performs sentiment analysis for categorizing text as positive or negative, text embedding to transform text into n-dimensional numerical vector representations, and semantic search for matching queries with the most relevant results based on those embeddings, alongside many other features. Hugging face is used in this project.
